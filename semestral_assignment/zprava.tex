...
\begin{itemize}
    ...
    \item \textbf{Pomalý mód} $s = -0.5$ ukázal nejlepší vlastnosti co se týče řízení stavových veličin k nule. Odpovídající regulátor
    \begin{equation*}
        K = \begin{bmatrix}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=\linewidth]{stabilizace_lin_pocpodminky.eps}}
    \caption{}
    \label{fig:stabilizace_lin_model}        
\end{figure}
\begin{figure}[htbp]
    \centerline{\includegraphics[width=\linewidth]{stabilizace_nelin_pocpodminky.eps}}
    \caption{}
    \label{fig:stabilizace_nelin}        
\end{figure}
