...
Dynamika motorů je stabilní a ve srovnání s dynamikou zbytku soustavy diktovanou póly
\begin{equation*}
	\text{eig}(\mathbf{A}) =
	\begin{cases}
        0 \\
    ...
    \end{cases}
\end{equation*}
zanedbatelná. Integrační charakter pólu v počátku i poloha kolem bodu $-6$ je několikrát pomalejší než pól v bodě $-27$ a dynamika
motorů tak nebude zásadně ovlivňovat soustavu.
